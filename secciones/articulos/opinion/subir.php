...
$sql1="INSERT INTO  articulo (titulo,detalle,fecha_creado,fk_imagen,fk_seccion,fk_autor,fk_estatus) values('".$_POST['titulo']."','".$_POST['detalle']."','".$fecha."',".$id.",'4','1','".$_POST['estatus']."') ";
