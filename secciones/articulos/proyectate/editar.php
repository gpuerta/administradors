 ...
 <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="recipient-name" value="<?=$empresa?>" name="empresa" required>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-4 col-form-label">Artículo</label>
                          <div class="col-sm-9">
                            <input type="text" class="form-control" id="recipient-name" value="<?=$articulo?>"  name="articulo" required>
                          </div>
                        </div>
                      </div>
                    </div>  
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input type="text" class="form-control" value="<?=$contacto?>"  id="recipient-name" name="contacto" required>
                          </div>
                        </div>
                      </div>
              ...
              <div class="form-group">
                <label for="message-text" class="col-form-label">Artículo:</label>
                 <textarea id="editor1" name="detalle" required  name="editor1" class="form-control" rows="10" cols="80"><?=$descripcion?></textarea>
              </div>
