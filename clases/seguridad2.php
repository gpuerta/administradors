...
if(!empty($_POST['cedula'])){
	...
	/* Connect To Database*/
     ...
     ?>
              ...
              <form class="pt-3" action="nueva_clave.php" method="post">
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="exampleInputEmail1" name="pregunta" value="<?=$pregunta?>" readonly>
                  <input type="hidden" class="form-control form-control-lg" id="exampleInputEmail1" name="cedula" value="<?=$cedula?>" readonly>
                </div>
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="exampleInputEmail1" name="respuesta" placeholder="Respuesta">
                </div>
      ...
      <?php 
					...
					echo"<script type=\"text/javascript\">alert('Error, cédula no encontrada'); window.location='../index.php';</script>";  
				} 
             }
		?>
            </div>
